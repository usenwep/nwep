...
BEGIN {
    ...
    require '/home/ethan/Workspace/nwep/third_party/quictls/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/ethan/Workspace/nwep/third_party/quictls/test/fips-and-base.cnf';
    shift;
